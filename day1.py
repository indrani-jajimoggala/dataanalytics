'''print("first class")
what is python?
--> Python is a high-level language means no need to worry about low-level management like memory allocation
--> Python never save anything permenantly, it will only save at run time '''

'''a=0
b=9
print(id(a))

# --> Python supports Object Orinented Programming Language(access the object)
...
# --> this is also called dynamically-typed language(no need to mention type of data your take in a variable)
...
# --> Python is interpered language(line by line execution)
-- python code converts into bytecode (complier). then goto the python virtual machine. (which reads the bytecode and execute the code line by line).
a=5
b=5
print(a+b)
